              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={site.url} target="_blank" className="text-sm text-blue-600 hover:underline">{site.domain}</a>
                  </div>
                </div>
                <span className="text-xs text-gray-400">{new Date(site.created_at).toLocaleDateString()}</span>
              </div>
