...
function SignInForm() {
  ...
  useEffect(() => {
    ...
    if (err === 'otp-verification-failed') setError('The magic link has expired or is invalid. Please request a new one.');
    if (err === 'auth-callback-failed') setError('Sign in failed. Please try again.');
  }, [searchParams]);
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.08] p-8">
          {sent ? (
            <div className="text-center py-4">
              ...
              <button onClick={() => setSent(false)} className="mt-4 text-sm text-slate-500 hover:text-slate-300 transition-colors">
            ...
            <>
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium transition-all mb-3 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium transition-all mb-6 disabled:opacity-50"
              >
